...
<Note>
**There are two AI Sync connections.** This page sets up the one that reads and
changes **your account**, which needs your login.

There is also a read-only connection to **these documentation pages** that needs
no account at all — useful for new reps and contractors. See
[Connect your agent to these docs](/agents/docs-mcp). Most teams run both.
</Note>
...
## ➡️ Now that you are connected

<CardGroup cols={2}>
<Card title="Connect the docs too" icon="book-open-reader" href="/agents/docs-mcp">
A read-only link to these pages. No login, safe for anyone.
</Card>
<Card title="Ask about your numbers" icon="chart-line" href="/agents/asking-about-your-data">
Questions that work, and how to tell a trustworthy answer from a confident one.
</Card>
<Card title="Run your dialer by chat" icon="terminal" href="/agents/running-your-dialer">
Make real changes safely, and what to confirm before you do.
</Card>
</CardGroup>
