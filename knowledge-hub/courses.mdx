...
This dialog allows you to assign the course to specific users or companies. The table includes:

- **Company Name**: The company or user display name.
- **Email**: The email address of the user.
- **Action**: An **Assign** button for each user/company. Clicking this assigns the course to them.

> **Tip:** The Assign dialog is only available for Private courses. For Public courses, users can self-enroll, and the assignment dialog is not shown.
