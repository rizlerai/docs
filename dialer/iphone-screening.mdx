...
<Step title="Pick or record an audio script">
It must be a **recording**. A typed script cannot play down a phone line, and
the dialer will stop you from starting with screening on until an audio one is
selected.
...
<Update label="22 Sep 2026" description="Screening">
**Screening detection was rebuilt.** AI Sync listens to the words rather than
the rhythm of the audio, because a screening prompt sounds acoustically like a
recorded greeting and systems judging cadence alone mistake it for an answering
machine.

A screened call is never counted as a conversation and never as voicemail.
</Update>
