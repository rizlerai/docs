...
<Note>
Power Dialer gives each rep their own lines. If several reps share one list,
[Predictive pacing](/dialer/predictive-pacing) hands that decision to the engine.

For what "connected" and "answered" actually count, see
...
<Update label="22 Sep 2026" description="Power Dialer">
**Your reporting now separates a conversation from a pickup.** A call that
reached voicemail, or that a phone screened on the lead's behalf, is no longer
counted as a connection. Your connect rate may read a little lower than before —
it was previously counting calls where nobody spoke to you.

**Picking your line count also puts you online.** You no longer have to set your
lines and then find a second control to start.
</Update>

See [What's New](/go-live/changelog) for everything, and
[How calls actually work](/dialer/how-calls-work) for what each outcome means.
