...
- **Business Identity**: Use different numbers for different campaigns or departments
- **Local Presence**: Select local area codes to improve answer rates in specific regions
...
Select and manage your contact lists directly from the interface:

- **PowerList Dropdown**: Switch between available contact lists
  - **"One Dial"**: Your primary calling list
  - **"devVS"**: Secondary or test list
- **List Status**: View upload and removal counts for the selected list
