...
<img src="/images/dialer/power-dialer/navigation.png" alt="Power Dialer Navigate" className="rounded-lg border shadow-sm" />
...
<img src="/images/dialer/power-dialer/pad-sidebar.png" alt="Power Dialer Sidebar" className="rounded-lg border shadow-sm" />
...
<img src="/images/dialer/power-dialer/dialpad.png" alt="Power Dialer Dialpad" className="rounded-lg border shadow-sm" />
...
<img src="/images/dialer/power-dialer/status.png" alt="Power Dialer Status" className="rounded-lg border shadow-sm" />
