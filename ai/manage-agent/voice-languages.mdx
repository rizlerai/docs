...
Select the artificial intelligence model that powers your agent's responses and conversation capabilities.
    ...
    <img
      src="/images/ai/Ai-agent/edit/voice-language/overview.png"
      alt="Voice and Language Configuration"
...
- **Claude 3.5 Haiku ($0.011/min)**
    ...
    <img
      src="/images/ai/Ai-agent/edit/voice-language/ai-model.png"
...
To change the voice, click on the voice field to open the voice selection dropdown. You can browse through available voices and use filters to narrow down your options:
    ...
    <img
      src="/images/ai/Ai-agent/edit/voice-language/voice-set.png"
      alt="Additional Information Form"
      className="rounded-lg border shadow-sm"
    />
...
- **Lily** (American, Young, female) - 11labs-Lily
    ...
    <img
      src="/images/ai/Ai-agent/edit/voice-language/voice-lists.png"
      alt="Additional Information Form"
      className="rounded-lg border shadow-sm"
    />
### ⚙️ Voice Settings 
...
You can experiment with these sliders to achieve the desired voice characteristics for your agent. Click "Close" to exit the settings modal.
    ...
    <img
      src="/images/ai/Ai-agent/edit/voice-language/languages.png"
      alt="Additional Information Form"
      className="rounded-lg border shadow-sm"
    />
## 🌍 Language Settings
...
- **Spanish (Spain)**
    ...
    <img
      src="/images/ai/Ai-agent/edit/voice-language/background-voice.png"
      alt="Additional Information Form"
      className="rounded-lg border shadow-sm"
    />
## 🔊 Background Sound
...
**Actions**: Save changes or Close without saving
    ...
    <img
      src="/images/ai/Ai-agent/edit/voice-language/background-voice-volume.png"
      alt="Additional Information Form"
      className="rounded-lg border shadow-sm"
    />