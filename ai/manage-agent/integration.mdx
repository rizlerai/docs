...
### 🔄 Map Call Direction to GHL Custom Field
- **Purpose**: Record whether a call was inbound or outbound in a specific GHL custom field
- **Custom Field Setup**: Create a custom field in GHL (e.g., "Call Direction") for this purpose
- **Mapping**: Map this field in the integration to automatically log the direction of each call
- **Benefit**: Facilitates directional call analytics and reporting within your CRM
