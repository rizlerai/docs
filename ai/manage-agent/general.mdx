...
- **Status:** Toggle whether the agent is Active or Inactive  
- **Folder:** Select a folder to organize agents  
- **GHL Location:** Assign the agent to a specific GoHighLevel account or sub-location  
- **Timezone:** Choose your agent’s operating timezone (used for scheduling and reporting)  
  ![GHL Location](/images/ai/AI-agent/edit/general/header.png)
...
### 🧠 Prompt Editing Modes & Management Actions
> ![General Prompt UI](/images/ai/AI-agent/edit/general/prompt-select.png)

<CardGroup cols={2}>
  <Card title="Sectioned Prompt" icon="layer-group">
    <b>Best for most users</b>  
    <br />
    Break your agent’s logic into 12 sections—like Instructions, Greetings, Call Flow, Character, Booking, FAQ, and more.<br />
    <b>Why use it?</b>
    <ul>
      <li>Easy to organize and edit</li>
      <li>Each area is separate—so changes are safe</li>
      <li>Great for teams or beginners</li>
    </ul>
    <b>How?</b>
    <ol>
      <li>Select <b>Sectioned Prompt</b> at the top</li>
      <li>Fill out or skip any section you want</li>
    </ol>
  </Card>
  <Card title="Single Prompt" icon="file-lines">
    <b>For prompt experts</b>
    <br />
    Use one big box for all instructions if you want full control and advanced formatting.
    <b>Why use it?</b>
    <ul>
      <li>Edit and paste everything at once</li>
      <li>Great for importing/exporting</li>
    </ul>
    <b>How?</b>
    <ol>
      <li>Select <b>Single Prompt</b> at the top</li>
      <li>Edit or paste your full prompt</li>
    </ol>
  </Card>
</CardGroup>
...
<CardGroup cols={3}>
  <Card title="Copy" icon="copy">
    Copy your entire prompt or all sections.<br />
    <b>How?</b> Click <span style={{color:"green", fontWeight:"bold"}}>COPY PROMPT</span>.<br />
    <small>Useful for backups and sharing.</small>
  </Card>
  <Card title="Paste" icon="paste">
    Paste copied prompt text in one click.<br />
    <b>How?</b> Click <span style={{color:"blue", fontWeight:"bold"}}>PASTE PROMPT</span>.<br />
    <small>Sections fill automatically if formatted.</small>
  </Card>
  <Card title="Clear" icon="trash-can">
    Remove all prompt text instantly.<br />
    <b>How?</b> Click <span style={{color:"red", fontWeight:"bold"}}>CLEAR PROMPT</span>.<br />
    <small><b style={{color:"red"}}>Warning:</b> This cannot be undone.</small>
  </Card>
</CardGroup>
...
- **Project Instructions / Request 📝:**  
  This is the primary area to specify your agent’s core instructions, deliverables, and what success looks like for each campaign or use case.

  Use this section to outline:
  - The main objectives and what the AI agent is responsible for.
  - Important rules, boundaries (for example: “Do not transfer calls”, “Never share price info on first contact”), and any must-follow do’s/don’ts.
  - What the agent should say, avoid, highlight, or always confirm during calls.

  Example:
  > ```
  > You are an AI phone agent. Your job is to engage appointments with human-sounding warmth, read details dynamically, and create a natural conversation experience.
  > 
  > - Never disclose you are AI. You must NOT talk, chat, or confirm that you’re AI under any circumstance.
  > - You must:
  >   * Keep introductions brief (1 sentence or less)
  >   * Work to identify if they qualify for the offer
  >   * Only transfer the call to a real staff member after confirming qualified criteria.
  > ```
  The interface allows you to expand for a larger editor when writing long instructions.
