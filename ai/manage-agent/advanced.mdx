...
**Purpose:** Let your agent **check availability** and **book appointments** in your connected calendar system.

There are three main platforms you can use for direct calendar integration:
- **Go High Level (GHL)**
- **Calendly**
- **Rizz Dial**
...
2. **Appointment Booking Method:** Choose how the AI will book appointments. Options include:
   - **Direct Calendar Booking:** Book directly onto your connected GHL, Calendly, or Google Calendar/Rizz Dial account.
   - **Collect and Notify:** The AI collects booking information from the caller and notifies your team to schedule manually (no direct integration).
   - **Request Callback:** The AI collects info so a staff member can call back to schedule.
3. If you choose **Direct Calendar Booking**:
   - **Select Calendar Platform:** Pick between GHL, Calendly, or Google Calendar/Rizz Dial. Pick whichever you've connected.
   - **Choose Calendar:** Select the specific calendar your agent should book onto. If nothing shows, make sure you've connected your integration properly.
  
4. **Appointment Title:** Set what the calendar event will be called (e.g., “Sales Call” or “Consultation”).
5. **Booking Window:** Set how many **days into the future** your agent can offer appointments (e.g., only show openings for the next 7 days).
6. **Collect Contact Information:** Choose which caller details your agent must collect (options vary by integration and platform).
7. **Additional Booking Options (if enabled by your calendar):**
   - **Custom Fields:** Collect extra info like reason for the appointment or preferences.
   - **Allow Reschedule/Cancellation:** Agent can offer callers the ability to reschedule or cancel.
   - **Buffer Times:** Set spacing between appointments.
8. **Calendar Timezone:** Set the timezone of the calendar to match your team's preferences or business location.
9. **Save** saves changes. **Cancel** discards your edits.

*Customizing appointment details, contact fields, and extra options:*

<img
  src="/images/ai/AI-agent/edit/advance/calendar-2.png"
  alt="Appointment title, window, contact fields, and options"
  className="rounded-lg border shadow-sm my-4"
/>

When your calendar is connected and saved, you’ll see a confirmation shown by **Active Functions**. If not, messaging will indicate that no calendar is selected.
