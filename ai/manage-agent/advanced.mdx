...
**Empower your  AI agent to breeze through phone menus using DTMF (Dual-Tone Multi-Frequency) keypad input!**  
...
When you select a GHL location for your agent, the system automatically maps the standard/default fields from that location for use in inbound call workflows. You don’t need to manually configure the basics—default fields exposed at that GHL location are auto-mapped so your inbound mapping starts aligned with what’s available in GHL.

![Advanced](/images/ai/AI-agent/edit/advance/GHL-fields.png)

**Custom and Additional Mappings**  
Auto-mapping covers the typical field set for your chosen location. If your workflow requires more, you can manually add, edit, or adjust mappings here:
- Map additional GHL fields that are important to your process.
- Adjust or replace mappings if the default setup doesn’t match your needs.

Examples of fields to map: Phone Number, Email, First Name, Last Name, Address, or any custom text field.

> Only the GHL fields mapped here will be accessible to the AI for inbound calls.
