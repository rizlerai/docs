...
![AI Dashboard Interface](/images/ai/filter-option.png)
...
![AI Dashboard Interface](/images/ai/cvc-pdf.png)



## Call Records Table
- **ID** - Unique identifier (sortable)
- **Action** - View, Edit, Delete buttons
- **Time** - Call timestamp (sortable)
- **Agent Name** - Handling agent (filterable)
- **From/To Number** - Phone numbers (searchable)
- **Call Duration** - Length in HH:MM:SS (sortable)
- **Call Type** - Web or Phone designation
- **Direction** - Visual call direction indicators
- **User Sentiment** - Color-coded sentiment badges
- **Hangup Reason** - Termination details (optional)
- **Call Successful** - Status indicator (optional)
- **Recording** - Audio playback controls
- **Call Summary** - AI overview (optional)
- **Call Transcript** - Transcription access (optional)
