...
|----------------|---------------------|---------------------------------------------------------------------|
| **#**          | Row Number          | Sequential number for each company entry                            |
| **Name**       | Company Identity    | Registered company name                                             |
| **Email**      | Contact Information | Company’s main email for communication and login                    |
| **Account Type** | Classification    | Designation of the business type (e.g., Company)                    |
| **VOIP**       | Service Status      | Indicates if VOIP/Dialer is enabled for the company                 |
...
| **Created At** | Timestamp           | Date and time when the company was added                            |
| **Action**     | Operations          | Actions available: Login, Edit, Delete                              |
