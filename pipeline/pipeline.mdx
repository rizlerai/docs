...
- When you need **step-by-step instructions** in formal wording.
- For **quick lookups** of terms, requirements, or constraints.
- When **troubleshooting** or confirming the “official” workflow.
- When your organization expects staff to follow **written procedures** alongside everyday work.

Use **this guide** for a readable tour; use **SOPs** for the structured, policy-style version inside the product.
