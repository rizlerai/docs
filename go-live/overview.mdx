...
| --- | --- | --- |
| Number registration (A2P 10DLC) | Carrier-dependent, unpredictable | **Start this first** — everything else can happen while you wait. Check the status rather than assuming a date |
...
<CardGroup cols={2}>
<Card title="Read your numbers" icon="chart-line" href="/dashboard/dialer-performance">
The Dialer Performance dashboard, and which figures to act on.
</Card>
<Card title="What the numbers mean" icon="diagram-project" href="/dialer/how-calls-work">
Connected, answered and screened are three different things.
</Card>
<Card title="Pace a shared list" icon="gauge-high" href="/dialer/predictive-pacing">
Predictive pacing, and the limits it will not cross.
</Card>
<Card title="Ask your AI agent" icon="robot" href="/agents/asking-about-your-data">
Get answers without opening the dashboard.
</Card>
</CardGroup>
