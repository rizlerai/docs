...
<Card title="✏️ Edit Role" icon="edit">
...
<Card title="💬 SMS Templates" icon="message-square">
**Permissions Available:**
- View SMS Template
- Add SMS Template
- Edit SMS Template
...
<Card title="⚡ Trigger Hooks" icon="zap">
**Permissions Available:**
- View Trigger Hooks
- Add Trigger Hooks
- Edit Trigger Hooks
...
<Card title="🎙️ Voice Templates" icon="mic">
**Permissions Available:**
- View Voice Template
- Add Voice Template
- Edit Voice Template
...
<Card title="📢 Voice Campaigns" icon="phone-call">
**Permissions Available:**
- View Voice Campaign
- Add Voice Campaign
- Edit Voice Campaign
...
<Card title="📝 PowerList Notes" icon="sticky-note">
**Permissions Available:**
...
<Card title="📊 Access Reports" icon="file-text">
