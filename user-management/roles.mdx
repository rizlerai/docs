...
<img src="/images/user-management/roles/permissions-1.png" alt="Permissions Management Interface" className="rounded-lg border shadow-sm" />
...
<img src="/images/user-management/roles/permissions-2.png" alt="Permissions Management Interface" className="rounded-lg border shadow-sm" />
<Info>
**Smart Permission Selection**: When you select any individual module, all sub-permissions within that module are automatically selected.
</Info>
<CardGroup cols={3}>
...
<img src="/images/user-management/roles/permissions-3.png" alt="Permissions Management Interface" className="rounded-lg border shadow-sm" />
<Info>
**Smart Permission Selection**: When you select any individual module, all sub-permissions within that module are automatically selected .
</Info>
<CardGroup cols={3}>
...
<img src="/images/user-management/roles/permissions-4.png" alt="Permissions Management Interface" className="rounded-lg border shadow-sm" />
<CardGroup cols={2}>
...
<CardGroup cols={1}>
  <Card title="📚 Knowledge Hub" icon="book">
    **Permissions Available:**
    ...
    - Build Knowledge Hub
    - Manage Knowledge File Assignments
    - Manage Knowledge Hub Categories
    - Admin Knowledge Hub
    - Manage Knowledge Hub Column

    **Use Case**: Control all operations and management within the Knowledge Hub, including file CRUD (Create, Read, Update, Delete), assignments, categorization, building, and admin tasks.
  </Card>
</CardGroup>
