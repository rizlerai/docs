...
<img src="/images/user-management/teams/overview.png" alt="Teams Management Overview" className="rounded-lg border shadow-sm" />
...
<Card title="⚙️ Setup Team" icon="gear">
...
<Card title="✏️ Edit Team" icon="pencil">
...
<img src="/images/user-management/teams/user-asign.png" alt="User Assignment to Teams" className="rounded-lg border shadow-sm" />
