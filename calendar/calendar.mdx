...
- View all your calendars in a list, each showing:
  - Calendar name and type (e.g., Personal, Company)
  - Description or notes
  - Status tags (e.g., Booking Enabled, Google Connected)
.- Click the menu (•••) on each calendar to:
...
To manage an existing calendar, click the menu (•••) on any calendar and select "Manage Calendar". This opens a detailed management interface with five tabs:
