...
At the top of the Calendar Management page, you'll see four colored stat cards:
...
Each card displays a large number and a label. The navigation breadcrumb at the top right is:
...
The selected tab is highlighted with a blue underline. Switching tabs updates the content below.
...
- **Pagination**: Navigate through pages of events using the Previous/Next controls at the bottom right.
...
- **Booking Enabled**: Shows if booking is enabled (green "Enabled" tag)
- **Google Connected**: Shows if the calendar is connected to Google (blue "Connected" or "Not Connected" tag)
- **Status**: Current status (green "Active" tag)
- **Created**: Date the calendar was created
- **Actions**: Manage (gear icon), Bookings (calendar icon), Edit (yellow icon), Delete (red trash icon)
