...
![calendar](/images/calendar/add-calendar.png)
...
![calendar](/images/calendar/create-new-calendar.png)
...
![calendar](/images/calendar/all-bookings.png)

### ⚙️ Settings

Adjust the main configuration options for your calendar here:

- **Calendar Name & Color**: Update the calendar’s name and select a color for easy identification.
- **Timezone**: Specify the timezone for event scheduling (e.g., Winnipeg, Canada, CST, CT).
- **Description**: Add or modify a brief summary or purpose of the calendar.
- **Booking & Activity Settings**:
  - **Allow slot booking**: Toggle to permit or restrict appointment bookings.
  - **Calendar active**: Activate or deactivate the calendar as needed.
  - **Available 24/7**: Optionally make availability round-the-clock, bypassing standard working hours.
- **Appointment Permissions**: Set who can book appointments (internal users, public, or both).
- **Calendar URL**: Access and copy your calendar’s shareable booking link.
- **Actions**: Save any updates, or delete the calendar if no longer needed.
