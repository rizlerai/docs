...
The Number Status Overview provides real-time insights into your phone number portfolio, helping you maintain clean numbers and identify potential spam issues before they impact your operations.
...
|-------------------|-----------------------------------------------------|----------------------|
| **Clean Numbers** | Numbers with good reputation and no spam flags      | 🟢 Teal/Green        |
| **Flagged Numbers** | Numbers identified as potential spam or problematic | 🔴 Red               |
| **All Numbers**   | Shows the total number of phone numbers you have    | 🔵 Blue              |
    
**📈 Visual Overview** 

**Donut Chart Visualization**
- **Clean Numbers**: Dominant teal section showing healthy numbers
- **Flagged Numbers**: Red section indicating problematic numbers
- **Interactive Legend**: Click to filter by status type

**Status Summary**
- **Clean Numbers Count**: Total healthy numbers in your portfolio
- **Flagged Numbers Count**: Numbers requiring attention
- **Total Numbers**: Complete portfolio size

**📋 Detailed Management**

Numbers that are flagged as spam or identified as problematic are displayed in a detailed table below, allowing you to review their status and related information at a glance.
