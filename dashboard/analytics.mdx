...
![Dialer Analytics Dashboard](/images/dashboard/analytics/disposition-summary.png)
---
...
On the main dashboard, clear charts and figures show:

- **Talk Time:** Total conversation time (hours:minutes:seconds) for your selected dates.
- **Metrics Row at the Top:**
    1. **No Answer**: Outgoing calls without a connection.
    2. **Connected**: Outgoing calls where someone answered.
    3. **PickUp Rate**: Percentage of outgoings that reached someone (Connected ➗ Outgoing × 100).
    4. **Missed Calls**: Incoming calls your team didn’t pick up.
    5. **Voicemails:** Messages customers left when they reached voicemail.
    6. **Answered:** Incoming calls your team successfully handled.
